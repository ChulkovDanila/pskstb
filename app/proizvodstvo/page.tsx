...
export default function ProizvodstvoPage() {
  ...
  useEffect(() => {
    const sections = ['frezervanie', 'flancy', 'ognebiozashchita', 'promyshlennyy-okras'];
  ...
  const SectionHeader = ({ title }: { title: string }) => (
    <h2 className="text-4xl font-bold text-[#002f45] mb-8">
      {title}
    </h2>
  );
  ...
  return (
    <main className="flex flex-col items-center px-4">
      ...
      <div className="w-full max-w-7xl mx-auto pt-36 pb-8">
        <h1 className="text-5xl font-extrabold text-[#002f45] mb-16 text-center">
          Наше производство
        </h1>
        
        {/* Статья 1: Фрезерование изделий в промышленных объемах */}
        <section id="frezervanie" className="mb-32 scroll-mt-36">
          <SectionHeader title="Фрезерование изделий в промышленных объемах" />
          ...
          <div className="space-y-8 text-gray-700 text-lg leading-relaxed">
            ...
            <div className="bg-gradient-to-r from-[#f8f9fa] to-[#e9ecef] p-8 rounded-xl border-l-4 border-[#fbbf24] shadow-lg">
            ...
            {/* Наши возможности */}
            <div className="bg-gradient-to-r from-[#f8f9fa] to-[#e9ecef] p-8 rounded-xl border-l-4 border-[#f59e0b] shadow-lg">
            ...
            {/* Почему выбирают нас */}
            <div className="bg-gradient-to-r from-[#f8f9fa] to-[#e9ecef] p-8 rounded-xl border-l-4 border-[#d97706] shadow-lg">
            ...
            {/* Призыв к действию */}
            <div className="bg-gradient-to-r from-[#f8f9fa] to-[#e9ecef] p-8 rounded-xl border-l-4 border-[#b45309] text-center shadow-lg">
        ...
        <section id="ognebiozashchita" className="mb-32 scroll-mt-36">
          <SectionHeader title="Огнебиозащита" />
        ...
        <section id="promyshlennyy-okras" className="mb-32 scroll-mt-36">
          <SectionHeader title="Промышленный окрас для древесины и фанеры" />
